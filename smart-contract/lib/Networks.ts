...
export const shibariumTestnet: NetworkConfigInterface = {
  chainId: 719,
  symbol: 'BONE',
  blockExplorer: {
    name: 'Puppy Net',
    generateContractUrl: (contractAddress: string) => `https://https://puppyscan.shib.io/address/${contractAddress}`,
    generateTransactionUrl: (transactionAddress: string) => `https://https://puppyscan.shib.io/tx/${transactionAddress}`,
  },
}

export const shibariumMainnet: NetworkConfigInterface = {
  chainId: 109,
  symbol: 'BONE',
  blockExplorer: {
    name: 'Shibariumscan',
    generateContractUrl: (contractAddress: string) => `https://shibariumscan.io/address/${contractAddress}`,
    generateTransactionUrl: (transactionAddress: string) => `https://shibariumscan.io/tx/${transactionAddress}`,
  },
}
